...
import skribble.demo.repository.IWordRepository;
import skribble.demo.service.WordService;
...
public class DatabaseTests {
    ...
    @Test
    void testUpdateWord() {
        Word existingWord = new Word(1, "OldWord");
        Word updatedWord = new Word(1, "NewWord");
